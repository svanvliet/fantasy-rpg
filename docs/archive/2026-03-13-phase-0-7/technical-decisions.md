...
## TD-016: Post-Prototype Priorities Should Favor First-Person Depth Over Scope Expansion

- Status: `accepted`
- Phase: `7`
- Date: `2026-03-13`
- Decision:
  Prioritize first-person embodiment, item-system depth, and lightweight world-purpose systems before third-person support or heavier rendering expansion.
- Why:
  The prototype has already validated the core browser-first engine direction. The biggest remaining gaps are now gameplay depth and embodied world interaction, not proof of rendering viability or alternate camera modes.
- Consequences:
  Near-term work should favor hands/arms, alchemy depth, and minimal authored world structure.
  Third-person support and more ambitious rendering work remain intentionally deferred until the first-person loop is richer and more stable.
